...
import static net.minecraft.block.MultifaceGrowthBlock.canGrowOn;
import static net.minecraft.block.MultifaceGrowthBlock.hasDirection;

public class DenseCobwebBlock extends CobwebBlock {
    ...
    private static Map<Direction, BooleanProperty> FACING_PROPERTIES;
    private static Map<Direction, VoxelShape> SHAPES_FOR_DIRECTIONS;
    ...
    public DenseCobwebBlock(Settings settings) {
        super(settings);
        this.setDefaultState(withAllDirections(this.stateManager));
        this.SHAPES = this.getShapesForStates(DenseCobwebBlock::getShapeForState);
